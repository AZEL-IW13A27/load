...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["Starting W!think", "Please wait for a while", "Loading font", "Loading design", "Starting W!think", "Loading motivation", "Loading issues","Preparing to start","W!think started","Isn't it slow to load?"]);
  ...
  function animateLoading() {
    ...
    upward_moving_group.currentY -= 1.15 * easeInOut(now);
